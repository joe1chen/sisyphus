...
c(this.elements).not(":submit").not(":reset").not(":button");a.options.excludeFields&&(d=d.not(a.options.excludeFields));d.each(function(){var d=c(this);d.is(":text")||d.is("textarea")?a.options.timeout||a.bindSaveDataImmediately(d):a.bindSaveDataOnChange(d)})})},saveAllData:function(){var a=this;a.targets.each(function(){var d=c(this).attr("id"),b=c(this.elements).not(":submit").not(":reset").not(":button");a.options.excludeFields&&(b=b.not(a.options.excludeFields));b=b.serialize();d=a.href+d+field.attr("name")+
a.options.customKeyPrefix;a.saveToBrowserStorage(d,b,!1)});c.isFunction(a.options.onSave)&&a.options.onSave.call()},restoreAllData:function(){var a=this;c.isFunction(a.options.onBeforeRestore)&&a.options.onBeforeRestore.call();a.targets.each(function(){var d=c(this),b=d.attr("id"),b=a.href+b+field.attr("name")+a.options.customKeyPrefix;(b=a.browserStorage.get(b))&&d.deserialize(b,function(){c.isFunction(a.options.onRestore)&&a.options.onRestore.call()})})},bindSaveDataImmediately:function(a){var d=
...
1E3*a.options.timeout)},bindReleaseData:function(){var a=this;a.targets.each(function(){var b=c(this).attr("id");c(this).bind("submit reset",function(){a.releaseData(b)})})},manuallyReleaseData:function(){var a=this;a.targets.each(function(){var b=c(this).attr("id");a.releaseData(b)})},releaseData:function(a){this.browserStorage.remove(this.href+a+field.attr("name")+this.options.customKeyPrefix);c.isFunction(this.options.onRelease)&&this.options.onRelease.call()}}}b=e=null;return{getInstance:function(){e||
(e=f(),e.setInitialOptions());return e},free:function(){e=b=void 0;return null}}}()})(jQuery);