...
c(this.elements).not(":submit").not(":reset").not(":button");a.options.excludeFields&&(d=d.not(a.options.excludeFields));d.each(function(){var d=c(this);d.is(":text")||d.is("textarea")?a.options.timeout||a.bindSaveDataImmediately(d):a.options.timeout||a.bindSaveDataOnChange(d)})})},saveAllData:function(){var a=this;a.targets.each(function(){var d=c(this).attr("id"),b=c(this.elements).not(":submit").not(":reset").not(":button");a.options.excludeFields&&(b=b.not(a.options.excludeFields));b=b.serialize();
a.saveToBrowserStorage(a.href+d+a.options.customKeyPrefix,b,!1)});c.isFunction(a.options.onSave)&&a.options.onSave.call()},restoreAllData:function(){var a=this;a.targets.each(function(){var d=c(this),b=d.attr("id");if(b=a.browserStorage.get(a.href+b+a.options.customKeyPrefix)){var e=!0;c.isFunction(a.options.onBeforeRestore)&&(e=a.options.onBeforeRestore.call());e&&d.deserialize(b,function(){c.isFunction(a.options.onRestore)&&a.options.onRestore.call()})}})},bindSaveDataImmediately:function(a){var d=
this;if(null==c.browser.msie)a.on("input",function(){d.saveAllData()});else a.on("propertychange",function(){d.saveAllData()})},saveToBrowserStorage:function(a,d,b){b=null==b?!0:b;this.browserStorage.set(a,d);b&&(""!==d&&c.isFunction(this.options.onSave))&&this.options.onSave.call()},bindSaveDataOnChange:function(a){var b=this;a.change(function(){b.saveAllData()})},saveDataByTimeout:function(){var a=this;setTimeout(function(){function b(){a.saveAllData();setTimeout(b,1E3*a.options.timeout)}return b}(a.targets),
1E3*a.options.timeout)},bindReleaseData:function(){var a=this;a.targets.each(function(){var b=c(this).attr("id");c(this).bind("submit reset",function(){a.releaseData(b)})})},manuallyReleaseData:function(){var a=this;a.targets.each(function(){var b=c(this).attr("id");a.releaseData(b)})},releaseData:function(a){this.browserStorage.remove(this.href+a+this.options.customKeyPrefix);c.isFunction(this.options.onRelease)&&this.options.onRelease.call()}}}b=e=null;return{getInstance:function(){e||(e=f(),e.setInitialOptions());
return e},free:function(){e=b=void 0;return null}}}()})(jQuery);